    ...
    def _Decode(self, saver, sess):
        ...
        while True:
            if self._dec_reader._input_queue.empty():
                break
            (article, topic_vector, article_lens, origin_articles,
            ...
            best_beam = bs.BeamSearch(sess, article, topic_vector, article_lens)[0]
            decode_output = [int(t) for t in best_beam.tokens[1:]]
            self._DecodeBatch(
                origin_articles, origin_abstracts, decode_output)
